...
import org.jacoco.report.internal.html.table.FractionColumn;
...
public class HTMLFormatter implements IHTMLReportContext {
    ...
    private Table createTable() {
        ...
        t.add("Instructions Covered", Styles.BAR,
        ...
        t.add("Branches Covered", Styles.BAR,
...
//		addMissedTotalColumns(t, "Cxty", CounterEntity.COMPLEXITY);
        addCoveredTotalColumns(t, "Lines", CounterEntity.LINE);
        addCoveredTotalColumns(t, "Methods", CounterEntity.METHOD);
        addCoveredTotalColumns(t, "Classes", CounterEntity.CLASS);
        return t;
    }

    private void addCoveredTotalColumns(final Table table, final String label,
                                        final CounterEntity entity) {
        table.add(label , Styles.CTR1,
                new FractionColumn(entity, locale), false);
